...
//
//	mockgen -source pid_logger.go -destination mocks/pid_logger_mock.go
//
...
func (mr *MockPIDLoggerMockRecorder) ExecutePID(header, mode, pid, formula, protocol, name any) *gomock.Call {
